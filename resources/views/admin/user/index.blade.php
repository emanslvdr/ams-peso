...
<div class="max-w-7xl mx-auto p-6">
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl font-bold">Applicants Account</h1>
        <a href="{{route('users.create')}}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">+</a>
    </div>
            ...
            <tbody>
                ...
                <tr class="border-t">
                    ...
                    <td class="px-4 py-2 flex gap-2">
                        ...
                        <button onclick="openDeleteModal('{{route('users.destroy', $user)}}')" class="text-red-600 hover:underline">
                            Delete
                        </button>
                    </td>
                </tr>
