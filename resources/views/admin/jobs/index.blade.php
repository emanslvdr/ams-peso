<x-admin-layout>
    ...
    <div class="max-w-4xl mx-auto p-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('jobs.create')}}" class="px-4 py-2 bg-blue-600 text-white rounded">+</a>
        </div>
                ...
                <tbody>
                    ...
                    <tr class="border-t">
                        ...
                        <td class="px-4 py-2 flex gap-2">
                            <a href="{{ route('jobs.edit', $job) }}" class="text-blue-600 hover:underline">Edit</a>
                            <button onclick="openDeleteModal('{{ route('jobs.destroy', $job) }}')" class="text-red-600 hover:underline">
                                Delete
                            </button>
                        </td>
                    </tr>
