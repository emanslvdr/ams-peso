...
<div class="max-w-4xl mx-auto p-6">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('organizations.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">+</a>
    </div>
        ...
        <table class="min-w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="border-t">
                    ...
                    <td class="px-4 py-2">{{ $organization->jobs_count }}</td>
                    <td class="px-4 py-2 flex gap-2">
                        <a href="{{ route('organizations.jobs', $organization) }}" class="text-green-600 hover:underline">Open</a>
                        <a href="{{ route('organizations.edit', $organization) }}" class="text-blue-600 hover:underline">Edit</a>
                        <button onclick="openDeleteModal('{{ route('organizations.destroy', $organization) }}')" class="text-red-600 hover:underline">
                            Delete
                        </button>
                    </td>
                </tr>
