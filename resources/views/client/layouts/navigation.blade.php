    ...
    <ul>
        ...
        {{-- <li class="{{ request()->routeIs('organizations.index') ? 'active' : '' }}">
            <a href="{{ route('organizations.index') }}">
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M80-120v-720h400v160h400v560H80Zm80-80h240v-80H160v80Zm0-160h240v-80H160v80Zm0-160h240v-80H160v80Zm0-160h240v-80H160v80Zm320 480h320v-400H480v400Zm80-240v-80h160v80H560Zm0 160v-80h160v80H560Z"/></svg>
        ...
        <li class="{{ request()->routeIs('client.applicants.index') ? 'active' : '' }}">
            <a href="{{ route('client.applicants.index') }}">
        ...
        {{-- <li>
            ...
            <ul class="sub-menu">
                <div>
                    <li><a href="{{route('organizations.create')}}">Organization</a></li>
                    <li><a href="{{ route('jobs.create')}}">Jobs</a></li>
                    <li><a href="{{ route('admin.create.user')}}">User</a></li>
                </div>
            </ul>
        </li> --}}
        <li>
